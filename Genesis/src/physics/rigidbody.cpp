...
{
    m_pShape = nullptr;
    SDL_assert( ( ci.GetMass() > 0 && ci.GetMotionType() == MotionType::Dynamic ) || ( ci.GetMass() == 0 && ci.GetMotionType() == MotionType::Static ) );
...
void RigidBody::CalculateInvInertiaTensorWorld()
{
