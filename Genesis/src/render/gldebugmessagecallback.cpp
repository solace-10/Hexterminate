...
bool IsErrorIgnored( GLuint id )
{
    return id == 131218; // Vertex shader in program XX is being recompiled based on GL state.
}
...
{
    if ( IsSeverityIgnored( severity ) || IsErrorIgnored( id ) )
    {
        return;
    }
