...
class DefendRequestInfo : public ImperialRequestInfo
{
public:
    virtual ImperialRequestType GetType() const override { return ImperialRequestType::Defend; }
    virtual int GetMaximumRequests() const override { return 10; }
    virtual float GetMinimumTimeBetweenRequests() const override { return 1.0f; }
