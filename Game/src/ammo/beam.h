...
private:
    void SetupBeam();
    void SetupBeamFlare();
    void RenderBeam( const glm::mat4& modelMatrix, const Genesis::Color& beamColor, float opacity );
    void RenderBeamFlare( const glm::mat4& modelMatrix, const Genesis::Color& beamColor, float opacity );
